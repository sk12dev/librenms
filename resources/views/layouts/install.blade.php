...
<div class="container">
    <div class="card col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12 primary-panel">
        <div class="card-img-top">
            <img class="card-img-top p-4" src="{{ asset(\App\Facades\LibrenmsConfig::get('title_image', \App\View\Components\Logo::DEFAULT_IMAGE)) }}" alt="{{ \App\Facades\LibrenmsConfig::get('project_name', 'Dashboard by STEP') }}">
